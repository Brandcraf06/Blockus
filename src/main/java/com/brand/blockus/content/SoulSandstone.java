...
public class SoulSandstone {
	...
	public static void init() {
		...
		SOUL_SANDSTONE_BRICKS = new BlockBase("soul_sandstone_bricks", 0.8f, 4.0f);
		SOUL_SANDSTONE_BRICKS_STAIRS = new StairsBase(SOUL_SANDSTONE_BRICKS.getDefaultState(), "soul_sandstone_bricks_stairs", 0.8f, 4.0f);
		SOUL_SANDSTONE_BRICKS_SLAB = new SlabBase("soul_sandstone_bricks_slab", 2.0f, 4.0f);
		SOUL_SANDSTONE = new BlockBase("soul_sandstone", 0.8f, 4.0f);
		SOUL_SANDSTONE_STAIRS = new StairsBase(SOUL_SANDSTONE.getDefaultState(), "soul_sandstone_stairs", 0.8f, 4.0f);
		SOUL_SANDSTONE_SLAB = new SlabBase("soul_sandstone_slab", 2.0f, 4.0f);
		SMOOTH_SOUL_SANDSTONE = new BlockBase("smooth_soul_sandstone", 0.8f, 4.0f);
		SMOOTH_SOUL_SANDSTONE_STAIRS = new StairsBase(SMOOTH_SOUL_SANDSTONE.getDefaultState(), "smooth_soul_sandstone_stairs", 8.0f, 4.0f);
		SMOOTH_SOUL_SANDSTONE_SLAB = new SlabBase("smooth_soul_sandstone_slab", 2.0f, 4.0f);
		CUT_SOUL_SANDSTONE = new BlockBase("cut_soul_sandstone", 0.8f, 4.0f);
		CUT_SOUL_SANDSTONE_SLAB = new SlabBase("cut_soul_sandstone_slab", 2.0f, 4.0f);
		CHISELED_SOUL_SANDSTONE = new BlockBase("chiseled_soul_sandstone", 0.8f, 4.0f);
		SOUL_SANDSTONE_WALL = new WallBase("soul_sandstone_wall", 0.8f, 4.0f);	
	}

...
public class SoulSandstone {
	...
	public static void init() {
		...
		SOUL_SANDSTONE_BRICKS_STAIRS = new StairsBase(SOUL_SANDSTONE_BRICKS.getDefaultState(), "soul_sandstone_bricks_stairs", 0.8f, 0.8f);
		...
		SOUL_SANDSTONE_STAIRS = new StairsBase(SOUL_SANDSTONE.getDefaultState(), "soul_sandstone_stairs", 0.8f, 0.8f);
		...
		SMOOTH_SOUL_SANDSTONE_STAIRS = new StairsBase(SMOOTH_SOUL_SANDSTONE.getDefaultState(), "smooth_soul_sandstone_stairs", 8.0f, 0.8f);

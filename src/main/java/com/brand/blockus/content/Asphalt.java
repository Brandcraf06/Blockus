...
public class Asphalt {
	...
	public static void init() {
		...
		ASPHALT_STAIRS = new AsphaltStairs(ASPHALT.getDefaultState(), "asphalt_stairs", 1.5f, 6.0f);
		WHITE_ASPHALT_STAIRS = new AsphaltStairs(WHITE_ASPHALT.getDefaultState(), "white_asphalt_stairs", 1.5f, 6.0f);
		ORANGE_ASPHALT_STAIRS = new AsphaltStairs(ORANGE_ASPHALT.getDefaultState(), "orange_asphalt_stairs", 1.5f, 6.0f);
		MAGENTA_ASPHALT_STAIRS = new AsphaltStairs(MAGENTA_ASPHALT.getDefaultState(), "magenta_asphalt_stairs", 1.5f, 6.0f);
		LIGHT_BLUE_ASPHALT_STAIRS = new AsphaltStairs(LIGHT_BLUE_ASPHALT.getDefaultState(), "light_blue_asphalt_stairs", 1.5f, 6.0f);
		YELLOW_ASPHALT_STAIRS = new AsphaltStairs(YELLOW_ASPHALT.getDefaultState(), "yellow_asphalt_stairs", 1.5f, 6.0f);
		LIME_ASPHALT_STAIRS = new AsphaltStairs(LIME_ASPHALT.getDefaultState(), "lime_asphalt_stairs", 1.5f, 6.0f);
		PINK_ASPHALT_STAIRS = new AsphaltStairs(PINK_ASPHALT.getDefaultState(), "pink_asphalt_stairs", 1.5f, 6.0f);
		LIGHT_GRAY_ASPHALT_STAIRS = new AsphaltStairs(LIGHT_GRAY_ASPHALT.getDefaultState(), "light_gray_asphalt_stairs", 1.5f, 6.0f);
		GRAY_ASPHALT_STAIRS = new AsphaltStairs(GRAY_ASPHALT.getDefaultState(), "gray_asphalt_stairs", 1.5f, 6.0f);
		CYAN_ASPHALT_STAIRS = new AsphaltStairs(CYAN_ASPHALT.getDefaultState(),  "cyan_asphalt_stairs", 1.5f, 6.0f);
		PURPLE_ASPHALT_STAIRS = new AsphaltStairs(PURPLE_ASPHALT.getDefaultState(), "purple_asphalt_stairs", 1.5f, 6.0f);
		BLUE_ASPHALT_STAIRS = new AsphaltStairs(BLUE_ASPHALT.getDefaultState(), "blue_asphalt_stairs", 1.5f, 6.0f);
		BROWN_ASPHALT_STAIRS = new AsphaltStairs(BROWN_ASPHALT.getDefaultState(), "brown_asphalt_stairs", 1.5f, 6.0f);

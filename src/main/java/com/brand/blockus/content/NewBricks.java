...
//soaked
	public static final BlockBase SOAKED_BRICKS = new BlockBase("soaked_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.CYAN);
...
//honeycomb	
	public static final BlockBase HONEYCOMB_BRICKS = new BlockBase("honeycomb_bricks", 0.6f, 1.0f, Material.ORGANIC_PRODUCT, BlockSoundGroup.CORAL, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.ORANGE);
	...
	//soaked
	public static final BlockBase CHARRED_BRICKS = new BlockBase("charred_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.BLACK);
...
//bricks	
	public static final BlockBase LARGE_BRICKS = new BlockBase("large_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.RED);
	public static final BlockBase ZIGZAGGED_BRICKS = new BlockBase("zigzagged_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.RED);

...
public class SandstoneBricks {
    ...
    // Sandstone
    public static final BlockBase ROUGH_SANDSTONE = new BlockBase("rough_sandstone", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.SAND);
    ...
    public static final BlockBase SANDSTONE_BRICKS = new BlockBase("sandstone_bricks", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.SAND);
    ...
    public static final BlockBase SMALL_SANDSTONE_BRICKS = new BlockBase("small_sandstone_bricks", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.SAND);
    ...
    // Red Sandstone
    public static final BlockBase ROUGH_RED_SANDSTONE = new BlockBase("rough_red_sandstone", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.SAND);
    ...
    public static final BlockBase RED_SANDSTONE_BRICKS = new BlockBase("red_sandstone_bricks", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.SAND);
    ...
    public static final BlockBase SMALL_RED_SANDSTONE_BRICKS = new BlockBase("small_red_sandstone_bricks", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.SAND);
    ...
    // Sandy Bricks
    public static final BlockBase SANDY_BRICKS = new BlockBase("sandy_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MapColor.SPRUCE);

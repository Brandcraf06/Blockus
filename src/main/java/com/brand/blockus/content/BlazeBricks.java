...
public class BlazeBricks {
	...
	public static final LightBlockBase BLAZE_BRICKS = new LightBlockBase("blaze_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, 15, MapColor.NETHER);
	...
	public static final LightPillarBase BLAZE_PILLAR = new LightPillarBase("blaze_pillar", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, 15, MapColor.NETHER);

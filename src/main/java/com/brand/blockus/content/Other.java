...
public class Other {
	...
	public static final BlockBase2 STARS_BLOCK = new BlockBase2("stars_block", 5.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, FabricToolTags.PICKAXES, 1, MaterialColor.BLACK);
	public static final BlockBase2 ENDER_BLOCK = new BlockBase2("ender_block", 5.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, FabricToolTags.PICKAXES, 1, MaterialColor.GREEN_TERRACOTTA);
	public static final BlockBase LARGE_BRICKS = new BlockBase("large_bricks", 2f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MaterialColor.RED);
	public static final BlockBase ZIGZAGGED_BRICKS = new BlockBase("zigzagged_bricks", 2f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MaterialColor.RED);

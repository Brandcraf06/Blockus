...
public class NetherBricksRelated {
	...
	public static final BlockBase SMOOTH_NETHER_BRICKS = new BlockBase("smooth_nether_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS);
	public static final BlockBase SMOOTH_RED_NETHER_BRICKS = new BlockBase("smooth_red_nether_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS);
	public static final BlockBase ZIGZAGGED_NETHER_BRICKS = new BlockBase("zigzagged_nether_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS);
	public static final BlockBase ZIGZAGGED_RED_NETHER_BRICKS = new BlockBase("zigzagged_red_nether_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS);
	public static final PillarBase NETHER_PILLAR = new PillarBase("nether_pillar", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE);
	public static final PillarBase RED_NETHER_PILLAR = new PillarBase("red_nether_pillar", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE);
//charred
	public static final BlockBase CHARRED_NETHER_BRICKS = new BlockBase("charred_nether_bricks", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS);
	public static final StairsBase CHARRED_NETHER_BRICKS_STAIRS = new StairsBase(NetherBricksRelated.CHARRED_NETHER_BRICKS.getDefaultState(), "charred_nether_bricks_stairs", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE);
	public static final SlabBase CHARRED_NETHER_BRICKS_SLAB = new SlabBase("charred_nether_bricks_slab", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE);
	public static final WallBase CHARRED_NETHER_BRICKS_WALL = new WallBase("charred_nether_bricks_wall", 2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE);

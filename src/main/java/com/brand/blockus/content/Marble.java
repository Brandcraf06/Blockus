...
public class Marble {
	...
	public static final CirclePavementBlock MARBLE_CIRCLE_PAVEMENT = new CirclePavementBlock("marble_circle_pavement", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE);

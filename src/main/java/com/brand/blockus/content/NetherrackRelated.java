...
public class NetherrackRelated {
    ...
    public static final GlazedLikeBlockBase NETHERRACK_CIRCLE_PAVEMENT = new GlazedLikeBlockBase("netherrack_circle_pavement", 1.0f, 0.4f, Material.STONE, BlockSoundGroup.NETHERRACK, FabricToolTags.PICKAXES, 0, MapColor.NETHER);

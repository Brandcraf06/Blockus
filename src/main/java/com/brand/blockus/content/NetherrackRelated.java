...
public class NetherrackRelated {
    ...
    public static final PlayerFacingBlockBase NETHERRACK_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("netherrack_circle_pavement", 1.0f, 0.4f, Material.STONE, BlockSoundGroup.NETHERRACK, FabricToolTags.PICKAXES, 0, MaterialColor.NETHER);

...
public class LegacyBlocks {
	...
	LEGACY_BRICKS = new BlockBase("legacy_bricks", 2.0f, 30.0f);
	...
	LEGACY_GRAVEL = new FallingGravelBase("legacy_gravel", 2.0f, 30.0f);
	LEGACY_COBBLESTONE = new BlockBase("legacy_cobblestone", 2.0f, 30.0f);
	LEGACY_MOSSY_COBBLESTONE = new BlockBase("legacy_mossy_cobblestone", 2.0f, 30.0f);
	LEGACY_IRON_BLOCK = new BlockBase("legacy_iron_block", 5.0f, 30.0f);
	LEGACY_GOLD_BLOCK = new BlockBase("legacy_gold_block", 5.0f, 30.0f);
	EXPLOSION_PROOF_LEGACY_GOLD_BLOCK = new BlockBase("legacy_explosion_proof_gold_block", 5.0f, 6000.0f);
	LEGACY_DIAMOND_BLOCK = new BlockBase("legacy_diamond_block", 5.0f, 30.0f);
	LEGACY_LAPIS_BLOCK = new BlockBase("legacy_lapis_block", 5.0f, 30.0f);
	...
	NETHER_REACTOR_CORE = new BlockBase("legacy_nether_reactor_core", 1.5f, 30.0f);

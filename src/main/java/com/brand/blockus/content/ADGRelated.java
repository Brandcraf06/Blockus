...
public class ADGRelated {
	...
	public static void init() {
		...
		ANDESITE_BRICKS_SLAB = new SlabBase("andesite_bricks_slab", 2.0f, 30.0f);
		...
		DIORITE_BRICKS_SLAB = new SlabBase("diorite_bricks_slab", 2.0f, 30.0f);
		...
		GRANITE_BRICKS_SLAB = new SlabBase("granite_bricks_slab", 2.0f, 30.0f);

...
public class General {
    ...
    public static final LampBlockBase BLAZE_LANTERN = new LampBlockBase("blaze_block", 0.3F, 0.3F, Material.GLASS, BlockSoundGroup.GLASS, Blockus.BLOCKUS_BUILDING_BLOCKS, 15, MaterialColor.ORANGE);
    ...
    // Quartz Blocks
    public static final BlockBase QUARTZ_TILES = new BlockBase("quartz_bricks", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MaterialColor.QUARTZ);
    public static final PlayerFacingBlockBase QUARTZ_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("quartz_circle_pavement", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MaterialColor.QUARTZ);
}
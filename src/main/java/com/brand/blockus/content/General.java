...
public class General {
	...
	// Barriers
	public static final BarrierBlock CAUTION_BARRIER = new BarrierBlock("caution_barrier", 1.5f, 1200.0f);
	public static final BarrierBlock ROAD_BARRIER = new BarrierBlock("road_barrier", 2f, 6.0f);

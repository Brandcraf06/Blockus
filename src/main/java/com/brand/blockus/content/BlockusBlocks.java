...
public class BlockusBlocks extends BlocksRegistration {
    ...
    public static final Block STONE_DOOR = registerDoor2("stone", 1.5f, 20.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MapColor.STONE_GRAY);
    public static final Block STONE_TRAPDOOR = registerTrapdoor2("stone", 1.5f, 20.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MapColor.STONE_GRAY);
    ...
    public static final Block POLISHED_LIMESTONE = registerBlockCopy("polished_limestone", LIMESTONE);
    ...
    public static final Block POLISHED_MARBLE = registerBlockCopy("polished_marble", MARBLE);
    ...
    public static final Block POLISHED_BLUESTONE = registerBlockCopy("smooth_bluestone", BLUESTONE);
    ...
    public static final Block BLAZE_LANTERN = registerLampBlock("blaze_block", 0.3F, 0.3F, Material.GLASS, BlockSoundGroup.GLASS, 15, MapColor.ORANGE);
    ...
    // Nether Bricks
    public static final Block POLISHED_NETHER_BRICKS = registerBlockCopy("smooth_nether_bricks", Blocks.NETHER_BRICKS);
    public static final Block POLISHED_RED_NETHER_BRICKS = registerBlockCopy("smooth_red_nether_bricks", Blocks.NETHER_BRICKS);
    ...
    public static final Block NETHER_BRICK_PILLAR = registerPillar("nether", Blocks.NETHER_BRICKS);
    public static final Block RED_NETHER_BRICK_PILLAR = registerPillar("red_nether", Blocks.NETHER_BRICKS);
    ...
    public static final Block POLISHED_CHARRED_NETHER_BRICKS = registerBlockCopy("smooth_charred_nether_bricks", CHARRED_NETHER_BRICKS);
    ...
    public static final Block CHARRED_NETHER_BRICK_PILLAR = registerPillar("charred_nether", CHARRED_NETHER_BRICKS);
    ...
    public static final Block POLISHED_TEAL_NETHER_BRICKS = registerBlockCopy("smooth_teal_nether_bricks", TEAL_NETHER_BRICKS);
    public static final Block ZIGZAGGED_TEAL_NETHER_BRICKS = registerBlockCopy("zigzagged_teal_nether_bricks", TEAL_NETHER_BRICKS);
    public static final Block TEAL_NETHER_BRICK_PILLAR = registerPillar("teal_nether", TEAL_NETHER_BRICKS);
    ...
    public static final Block WHITE_OAK_LEAVES = register("white_oak_leaves", new LeavesBlock(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).breakByTool(FabricToolTags.HOES).materialColor(MapColor.ORANGE).allowsSpawning(BlockusBlocks::canSpawnOnLeaves).suffocates(BlockusBlocks::never).blockVision(BlockusBlocks::never)));
    ...
    public static final Block REDSTONE_SAND = register("redstone_sand", new FallingRedstoneBlock(FabricBlockSettings.copyOf(Blocks.SAND).materialColor(MapColor.BRIGHT_RED).breakByTool(FabricToolTags.SHOVELS)));
    ...
    public static final Block LEGACY_LEAVES = register("legacy_leaves", new LeavesBlock(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).materialColor(MapColor.LIME).breakByTool(FabricToolTags.HOES).allowsSpawning(BlockusBlocks::canSpawnOnLeaves).suffocates(BlockusBlocks::never).blockVision(BlockusBlocks::never)));

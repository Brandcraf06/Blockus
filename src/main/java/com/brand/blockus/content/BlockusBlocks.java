...
public class BlockusBlocks extends BlocksRegistration {
    ...
    public static final Block STONE_DOOR = register("stone_door", registerStoneDoor(1.5f, 20.0f, Material.STONE, BlockSoundGroup.STONE, MapColor.STONE_GRAY));
    public static final Block STONE_TRAPDOOR = register("stone_trapdoor", registerStoneTrapdoor(1.5f, 20.0f, Material.STONE, BlockSoundGroup.STONE, MapColor.STONE_GRAY));
    ...
    public static final Block DRIPSTONE_PILLAR = registerPillar("dripstone", DRIPSTONE_BRICKS);
    ...
    public static final Block BLACKSTONE_DOOR = register("blackstone_door", registerStoneDoor(1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, MapColor.BLACK));
    public static final Block BLACKSTONE_TRAPDOOR = register("blackstone_trapdoor", registerStoneTrapdoor(1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, MapColor.BLACK));
    ...
    public static final Block SMALL_BLUESTONE_BRICK_WALL = registerWall("small_bluestone_bricks", SMALL_BLUESTONE_BRICKS);
    ...
    // Lava	Bricks
    public static final Block LAVA_BRICKS = register("lava_bricks", registerLightBlock(1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, 15, MapColor.STONE_GRAY));
    ...
    public static final Block LAVA_POLISHED_BLACKSTONE_BRICKS = register("lava_polished_blackstone_bricks", registerLightBlock(1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, 15, MapColor.BLACK));
    ...
    // Magma Bricks
    public static final Block MAGMA_BRICKS = register("magma_bricks", registerLightBlock(0.5f, 1.0f, Material.STONE, BlockSoundGroup.STONE, 15, MapColor.DARK_RED));
    ...
    // Blaze Bricks
    public static final Block BLAZE_BRICKS = register("blaze_bricks", registerLightBlock(2.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, 15, MapColor.DARK_RED));
    ...
    public static final Block BLAZE_LANTERN = register("blaze_lantern", registerLampBlock(0.3F, 0.3F, Material.GLASS, BlockSoundGroup.GLASS, 15, MapColor.ORANGE));
    ...
    public static final Block OBSIDIAN_REINFORCED_DOOR = register("obsidian_reinforced_door", registerStoneDoor(50.0F, 1200.0F, Material.METAL, BlockSoundGroup.STONE, MapColor.BLACK));
    public static final Block OBSIDIAN_REINFORCED_TRAPDOOR = register("obsidian_reinforced_trapdoor", registerStoneTrapdoor(50.0F, 1200.0F, Material.METAL, BlockSoundGroup.STONE, MapColor.BLACK));
    public static final Block GLOWING_OBSIDIAN = register("glowing_obsidian", registerLightBlock(50.0F, 1200.0F, Material.STONE, BlockSoundGroup.STONE, 15, MapColor.BLACK));
    ...
    public static final Block DARK_PRISMARINE_PILLAR = registerPillar("dark_prismarine", new OrientableBlockBase(FabricBlockSettings.copy(Blocks.DARK_PRISMARINE)));
    ...
    public static final Block BAMBOO_DOOR = register("bamboo_door", registerDoor(2.0f, 3.0f, Material.WOOD, BlockSoundGroup.WOOD, BAMBOO_PLANKS.getDefaultMapColor()));
    public static final Block BAMBOO_TRAPDOOR = register("bamboo_trapdoor", registerTrapdoor(2.0f, 3.0f, Material.WOOD, BlockSoundGroup.WOOD, BAMBOO_PLANKS.getDefaultMapColor()));
    ...
    public static final Block CHARRED_DOOR = register("charred_door", registerDoor(2.0f, 3.0f, Material.WOOD, BlockSoundGroup.WOOD, CHARRED_PLANKS.getDefaultMapColor()));
    public static final Block CHARRED_TRAPDOOR = register("charred_trapdoor", registerTrapdoor(2.0f, 3.0f, Material.WOOD, BlockSoundGroup.WOOD, CHARRED_PLANKS.getDefaultMapColor()));
    ...
    public static final Block POTTED_WHITE_OAK_SAPLING = register("potted_white_oak_sapling", registerPottedPlant(WHITE_OAK_SAPLING));
    ...
    public static final Block WHITE_OAK_DOOR = register("white_oak_door", registerDoor(2.0f, 3.0f, Material.WOOD, BlockSoundGroup.WOOD, WHITE_OAK_PLANKS.getDefaultMapColor()));
    public static final Block WHITE_OAK_TRAPDOOR = register("white_oak_trapdoor", registerTrapdoor(2.0f, 3.0f, Material.WOOD, BlockSoundGroup.WOOD, WHITE_OAK_PLANKS.getDefaultMapColor()));
    ...
    // Large Flower Pots
    public static final Block LARGE_FLOWER_POT = register("large_flower_pot", registerLargeFlowerPot(Blocks.AIR));
    public static final Block POTTED_ROSE_BUSH = register("potted_rose_bush", registerPottedDoublePlant(Blocks.ROSE_BUSH));
    public static final Block POTTED_LILAC = register("potted_lilac", registerPottedDoublePlant(Blocks.LILAC));
    public static final Block POTTED_PEONY = register( "potted_peony", registerPottedDoublePlant(Blocks.PEONY));
    public static final Block POTTED_LARGE_FERN = register( "potted_large_fern", registerPottedDoublePlant(Blocks.LARGE_FERN));
    public static final Block POTTED_OAK = register( "potted_oak", registerPottedDoublePlant(Blocks.OAK_SAPLING));
    public static final Block POTTED_SPRUCE = register( "potted_spruce", registerPottedDoublePlant(Blocks.SPRUCE_SAPLING));
    public static final Block POTTED_BIRCH = register( "potted_birch", registerPottedDoublePlant(Blocks.BIRCH_SAPLING));
    public static final Block POTTED_JUNGLE = register("potted_jungle", registerPottedDoublePlant(Blocks.JUNGLE_SAPLING));
    public static final Block POTTED_ACACIA = register( "potted_acacia", registerPottedDoublePlant(Blocks.ACACIA_SAPLING));
    public static final Block POTTED_DARK_OAK = register( "potted_dark_oak", registerPottedDoublePlant(Blocks.DARK_OAK_SAPLING));
    public static final Block POTTED_WHITE_OAK = register("potted_white_oak", registerPottedDoublePlant(WHITE_OAK_SAPLING));
    public static final Block POTTED_HUGE_RED_MUSHROOM = register("potted_huge_red_mushroom", registerPottedDoublePlant(Blocks.RED_MUSHROOM));
    public static final Block POTTED_HUGE_BROWN_MUSHROOM = register( "potted_huge_brown_mushroom", registerPottedDoublePlant(Blocks.BROWN_MUSHROOM));
    public static final Block POTTED_HUGE_CRIMSON_FUNGUS = register( "potted_huge_crimson_fungus", registerPottedDoublePlant(Blocks.CRIMSON_FUNGUS));
    public static final Block POTTED_HUGE_WARPED_FUNGUS = register( "potted_huge_warped_fungus", registerPottedDoublePlant(Blocks.WARPED_FUNGUS));
    public static final Block POTTED_CACTUS_LARGE = register( "potted_cactus_large", registerPottedDoublePlant(Blocks.CACTUS));
    public static final Block POTTED_BAMBOO_LARGE = register( "potted_bamboo_large", registerPottedDoublePlant(Blocks.BAMBOO));
    public static final Block POTTED_AZALEA_LARGE = register( "potted_azalea_large", registerPottedDoublePlant(Blocks.AZALEA));
    public static final Block POTTED_FLOWERING_AZALEA_LARGE = register("potted_flowering_azalea_large", registerPottedDoublePlant(Blocks.FLOWERING_AZALEA));


    // Food Blocks
    public static final Block SWEET_BERRIES_CRATE = register("sweet_berries_crate", registerCrates());
    public static final Block GLOW_BERRIES_CRATE = register("glow_berries_crate", registerLightCrates());
    public static final Block SALMON_CRATE = register("salmon_crate", registerCrates());
    public static final Block PUFFERFISH_CRATE = register("pufferfish_crate", registerCrates());
    public static final Block TROPICAL_FISH_CRATE = register("tropical_fish_crate", registerCrates());
    public static final Block COD_CRATE = register("cod_crate", registerCrates());
    ...
    public static final Block POTATO_CRATE = register("potato_crate", registerCrates());
    public static final Block APPLE_CRATE = register("apple_crate", registerCrates());
    public static final Block GOLDEN_APPLE_CRATE = register("golden_apple_crate", registerCrates());
    public static final Block BEETROOT_CRATE = register("beetroot_crate", registerCrates());
    public static final Block CARROT_CRATE = register("carrot_crate", registerCrates());
    public static final Block GOLDEN_CARROT_CRATE = register("golden_carrot_crate", registerCrates());
    ...
    public static final Block POTTED_RAINBOW_ROSE = register("potted_rainbow_rose", registerPottedPlant(RAINBOW_ROSE));
    ...
    public static final Block WHITE_STONE_BRICKS = register("white_stone_bricks", registerColoredStoneBricks(MapColor.WHITE));
    public static final Block ORANGE_STONE_BRICKS = register("orange_stone_bricks", registerColoredStoneBricks(MapColor.ORANGE));
    public static final Block MAGENTA_STONE_BRICKS = register("magenta_stone_bricks", registerColoredStoneBricks(MapColor.MAGENTA));
    public static final Block LIGHT_BLUE_STONE_BRICKS = register("light_blue_stone_bricks", registerColoredStoneBricks(MapColor.LIGHT_BLUE));
    public static final Block YELLOW_STONE_BRICKS = register("yellow_stone_bricks", registerColoredStoneBricks(MapColor.YELLOW));
    public static final Block LIME_STONE_BRICKS = register("lime_stone_bricks", registerColoredStoneBricks(MapColor.LIME));
    public static final Block PINK_STONE_BRICKS = register("pink_stone_bricks", registerColoredStoneBricks(MapColor.PINK));
    public static final Block GRAY_STONE_BRICKS = register("gray_stone_bricks", registerColoredStoneBricks(MapColor.GRAY));
    public static final Block CYAN_STONE_BRICKS = register("cyan_stone_bricks", registerColoredStoneBricks(MapColor.CYAN));
    public static final Block PURPLE_STONE_BRICKS = register("purple_stone_bricks", registerColoredStoneBricks(MapColor.PURPLE));
    public static final Block BLUE_STONE_BRICKS = register("blue_stone_bricks", registerColoredStoneBricks(MapColor.BLUE));
    public static final Block BROWN_STONE_BRICKS = register("brown_stone_bricks", registerColoredStoneBricks(MapColor.BROWN));
    public static final Block GREEN_STONE_BRICKS = register("green_stone_bricks", registerColoredStoneBricks(MapColor.GREEN));
    public static final Block RED_STONE_BRICKS = register("red_stone_bricks", registerColoredStoneBricks(MapColor.RED));
    public static final Block BLACK_STONE_BRICKS = register("black_stone_bricks", registerColoredStoneBricks(MapColor.BLACK));
    ...
    // Redstone Lamps
    public static final Block WHITE_REDSTONE_LAMP = register("white_redstone_lamp", registerRedstoneLamp());
    public static final Block ORANGE_REDSTONE_LAMP = register("orange_redstone_lamp", registerRedstoneLamp());
    public static final Block MAGENTA_REDSTONE_LAMP = register("magenta_redstone_lamp", registerRedstoneLamp());
    public static final Block LIGHT_BLUE_REDSTONE_LAMP = register("light_blue_redstone_lamp", registerRedstoneLamp());
    public static final Block YELLOW_REDSTONE_LAMP = register("yellow_redstone_lamp", registerRedstoneLamp());
    public static final Block LIME_REDSTONE_LAMP = register("lime_redstone_lamp", registerRedstoneLamp());
    public static final Block PINK_REDSTONE_LAMP = register("pink_redstone_lamp", registerRedstoneLamp());
    public static final Block GRAY_REDSTONE_LAMP = register("gray_redstone_lamp", registerRedstoneLamp());
    public static final Block LIGHT_GRAY_REDSTONE_LAMP = register("light_gray_redstone_lamp", registerRedstoneLamp());
    public static final Block CYAN_REDSTONE_LAMP = register("cyan_redstone_lamp", registerRedstoneLamp());
    public static final Block PURPLE_REDSTONE_LAMP = register("purple_redstone_lamp", registerRedstoneLamp());
    public static final Block BLUE_REDSTONE_LAMP = register("blue_redstone_lamp", registerRedstoneLamp());
    public static final Block BROWN_REDSTONE_LAMP = register("brown_redstone_lamp", registerRedstoneLamp());
    public static final Block GREEN_REDSTONE_LAMP = register("green_redstone_lamp", registerRedstoneLamp());
    public static final Block RED_REDSTONE_LAMP = register("red_redstone_lamp", registerRedstoneLamp());
    public static final Block REDSTONE_LAMP_LIT = register("redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block WHITE_REDSTONE_LAMP_LIT = register("white_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block ORANGE_REDSTONE_LAMP_LIT = register("orange_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block MAGENTA_REDSTONE_LAMP_LIT = register("magenta_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block LIGHT_BLUE_REDSTONE_LAMP_LIT = register("light_blue_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block YELLOW_REDSTONE_LAMP_LIT = register("yellow_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block LIME_REDSTONE_LAMP_LIT = register("lime_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block PINK_REDSTONE_LAMP_LIT = register("pink_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block GRAY_REDSTONE_LAMP_LIT = register("gray_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block LIGHT_GRAY_REDSTONE_LAMP_LIT = register("light_gray_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block CYAN_REDSTONE_LAMP_LIT = register("cyan_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block PURPLE_REDSTONE_LAMP_LIT = register("purple_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block BLUE_REDSTONE_LAMP_LIT = register("blue_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block BROWN_REDSTONE_LAMP_LIT = register("brown_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block GREEN_REDSTONE_LAMP_LIT = register("green_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block RED_REDSTONE_LAMP_LIT = register("red_redstone_lamp_lit", registerLitRedstoneLamp());
    public static final Block RAINBOW_LAMP = register("rainbow_lamp", registerRedstoneLamp());
    public static final Block RAINBOW_LAMP_LIT = register("rainbow_lamp_lit", registerLitRedstoneLamp());

    // Neon Blocks
    public static final Block WHITE_NEON = register("white_neon", registerNeonBlock(DyeColor.WHITE));
    public static final Block ORANGE_NEON = register("orange_neon", registerNeonBlock(DyeColor.ORANGE));
    public static final Block MAGENTA_NEON = register("magenta_neon", registerNeonBlock(DyeColor.MAGENTA));
    public static final Block LIGHT_BLUE_NEON = register("light_blue_neon", registerNeonBlock(DyeColor.LIGHT_BLUE));
    public static final Block YELLOW_NEON = register("yellow_neon", registerNeonBlock(DyeColor.YELLOW));
    public static final Block LIME_NEON = register("lime_neon", registerNeonBlock(DyeColor.LIME));
    public static final Block PINK_NEON = register("pink_neon", registerNeonBlock(DyeColor.PINK));
    public static final Block LIGHT_GRAY_NEON = register("light_gray_neon", registerNeonBlock(DyeColor.LIGHT_GRAY));
    public static final Block GRAY_NEON = register("gray_neon", registerNeonBlock(DyeColor.GRAY));
    public static final Block CYAN_NEON = register("cyan_neon", registerNeonBlock(DyeColor.CYAN));
    public static final Block PURPLE_NEON = register("purple_neon", registerNeonBlock(DyeColor.PURPLE));
    public static final Block BLUE_NEON = register("blue_neon", registerNeonBlock(DyeColor.BLUE));
    public static final Block BROWN_NEON = register("brown_neon", registerNeonBlock(DyeColor.BROWN));
    public static final Block GREEN_NEON = register("green_neon", registerNeonBlock(DyeColor.GREEN));
    public static final Block RED_NEON = register("red_neon", registerNeonBlock(DyeColor.RED));
    public static final Block BLACK_NEON = register("black_neon", registerNeonBlock(DyeColor.BLACK));

    // Futurneo Blocks
    public static final Block WHITE_FUTURNEO_BLOCK = register("white_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block ORANGE_FUTURNEO_BLOCK = register("orange_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block MAGENTA_FUTURNEO_BLOCK = register("magenta_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block LIGHT_BLUE_FUTURNEO_BLOCK = register("light_blue_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block YELLOW_FUTURNEO_BLOCK = register("yellow_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block LIME_FUTURNEO_BLOCK = register("lime_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block PINK_FUTURNEO_BLOCK = register("pink_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block GRAY_FUTURNEO_BLOCK = register("gray_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block GRAY_BRIGHT_FUTURNEO_BLOCK = register("gray_bright_futurneo_block", registerFuturneoBlock(MapColor.WHITE));
    public static final Block LIGHT_GRAY_FUTURNEO_BLOCK = register("light_gray_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block CYAN_FUTURNEO_BLOCK = register("cyan_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block PURPLE_FUTURNEO_BLOCK = register("purple_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block BLUE_FUTURNEO_BLOCK = register("blue_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block BROWN_FUTURNEO_BLOCK = register("brown_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block GREEN_FUTURNEO_BLOCK = register("green_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block RED_FUTURNEO_BLOCK = register("red_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block BLACK_FUTURNEO_BLOCK = register("black_futurneo_block", registerFuturneoBlock(MapColor.BLACK));
    public static final Block RAINBOW_FUTURNEO_BLOCK = register("rainbow_futurneo_block", registerFuturneoBlock(MapColor.BLACK));

    // Asphalt
    public static final Block ASPHALT = register("asphalt", registerAsphaltBlock(DyeColor.BLACK));
    public static final Block WHITE_ASPHALT = register("white_asphalt", registerAsphaltBlock(DyeColor.WHITE));
    public static final Block ORANGE_ASPHALT = register("orange_asphalt", registerAsphaltBlock(DyeColor.ORANGE));
    public static final Block MAGENTA_ASPHALT = register("magenta_asphalt", registerAsphaltBlock(DyeColor.MAGENTA));
    public static final Block LIGHT_BLUE_ASPHALT = register("light_blue_asphalt", registerAsphaltBlock(DyeColor.LIGHT_BLUE));
    public static final Block YELLOW_ASPHALT = register("yellow_asphalt", registerAsphaltBlock(DyeColor.YELLOW));
    public static final Block LIME_ASPHALT = register("lime_asphalt", registerAsphaltBlock(DyeColor.LIME));
    public static final Block PINK_ASPHALT = register("pink_asphalt", registerAsphaltBlock(DyeColor.PINK));
    public static final Block LIGHT_GRAY_ASPHALT = register("light_gray_asphalt", registerAsphaltBlock(DyeColor.LIGHT_GRAY));
    public static final Block GRAY_ASPHALT = register("gray_asphalt", registerAsphaltBlock(DyeColor.GRAY));
    public static final Block CYAN_ASPHALT = register("cyan_asphalt", registerAsphaltBlock(DyeColor.CYAN));
    public static final Block PURPLE_ASPHALT = register("purple_asphalt", registerAsphaltBlock(DyeColor.PURPLE));
    public static final Block BLUE_ASPHALT = register("blue_asphalt", registerAsphaltBlock(DyeColor.BLUE));
    public static final Block BROWN_ASPHALT = register("brown_asphalt", registerAsphaltBlock(DyeColor.BROWN));
    public static final Block GREEN_ASPHALT = register("green_asphalt", registerAsphaltBlock(DyeColor.GREEN));
    public static final Block RED_ASPHALT = register("red_asphalt", registerAsphaltBlock(DyeColor.RED));
    ...
    // Shingles
    public static final Block SHINGLES = register("shingles", registerShingles(Blocks.TERRACOTTA));
    public static final Block WHITE_SHINGLES = register("white_shingles", registerShingles(Blocks.WHITE_TERRACOTTA));
    public static final Block ORANGE_SHINGLES = register("orange_shingles", registerShingles(Blocks.ORANGE_TERRACOTTA));
    public static final Block MAGENTA_SHINGLES = register("magenta_shingles", registerShingles(Blocks.MAGENTA_TERRACOTTA));
    public static final Block LIGHT_BLUE_SHINGLES = register("light_blue_shingles", registerShingles(Blocks.LIGHT_BLUE_TERRACOTTA));
    public static final Block YELLOW_SHINGLES = register("yellow_shingles", registerShingles(Blocks.YELLOW_TERRACOTTA));
    public static final Block LIME_SHINGLES = register("lime_shingles", registerShingles(Blocks.LIME_TERRACOTTA));
    public static final Block PINK_SHINGLES = register("pink_shingles", registerShingles(Blocks.PINK_TERRACOTTA));
    public static final Block LIGHT_GRAY_SHINGLES = register("light_gray_shingles", registerShingles(Blocks.LIGHT_GRAY_TERRACOTTA));
    public static final Block GRAY_SHINGLES = register("gray_shingles", registerShingles(Blocks.GRAY_TERRACOTTA));
    public static final Block CYAN_SHINGLES = register("cyan_shingles", registerShingles(Blocks.CYAN_TERRACOTTA));
    public static final Block PURPLE_SHINGLES = register("purple_shingles", registerShingles(Blocks.PURPLE_TERRACOTTA));
    public static final Block BLUE_SHINGLES = register("blue_shingles", registerShingles(Blocks.BLUE_TERRACOTTA));
    public static final Block BROWN_SHINGLES = register("brown_shingles", registerShingles(Blocks.BROWN_TERRACOTTA));
    public static final Block GREEN_SHINGLES = register("green_shingles", registerShingles(Blocks.GREEN_TERRACOTTA));
    public static final Block RED_SHINGLES = register("red_shingles", registerShingles(Blocks.RED_TERRACOTTA));
    public static final Block BLACK_SHINGLES = register("black_shingles", registerShingles(Blocks.BLACK_TERRACOTTA));
    ...
    // Glass - Beveled Glass
    public static final Block RAINBOW_GLASS = register("rainbow_glass", registerStainedGlass(DyeColor.YELLOW, Blocks.GLASS));
    public static final Block RAINBOW_GLASS_PANE = register("rainbow_glass_pane", registerStainedGlassPane(DyeColor.YELLOW, Blocks.GLASS_PANE));
    public static final Block BEVELED_GLASS = register("beveled_glass", new Block(FabricBlockSettings.copy(Blocks.GLASS)));
    public static final Block WHITE_BEVELED_GLASS = register("white_beveled_glass", registerStainedGlass(DyeColor.WHITE, Blocks.WHITE_STAINED_GLASS));
    public static final Block ORANGE_BEVELED_GLASS = register("orange_beveled_glass", registerStainedGlass(DyeColor.ORANGE, Blocks.ORANGE_STAINED_GLASS));
    public static final Block MAGENTA_BEVELED_GLASS = register("magenta_beveled_glass", registerStainedGlass(DyeColor.MAGENTA, Blocks.MAGENTA_STAINED_GLASS));
    public static final Block LIGHT_BLUE_BEVELED_GLASS = register("light_blue_beveled_glass", registerStainedGlass(DyeColor.LIGHT_BLUE, Blocks.LIGHT_BLUE_STAINED_GLASS));
    public static final Block YELLOW_BEVELED_GLASS = register("yellow_beveled_glass", registerStainedGlass(DyeColor.YELLOW, Blocks.YELLOW_STAINED_GLASS));
    public static final Block LIME_BEVELED_GLASS = register("lime_beveled_glass", registerStainedGlass(DyeColor.LIME, Blocks.LIME_STAINED_GLASS));
    public static final Block PINK_BEVELED_GLASS = register("pink_beveled_glass", registerStainedGlass(DyeColor.PINK, Blocks.PINK_STAINED_GLASS));
    public static final Block LIGHT_GRAY_BEVELED_GLASS = register("light_gray_beveled_glass", registerStainedGlass(DyeColor.LIGHT_GRAY, Blocks.LIGHT_GRAY_STAINED_GLASS));
    public static final Block GRAY_BEVELED_GLASS = register("gray_beveled_glass", registerStainedGlass(DyeColor.GRAY, Blocks.GRAY_STAINED_GLASS));
    public static final Block CYAN_BEVELED_GLASS = register("cyan_beveled_glass", registerStainedGlass(DyeColor.CYAN, Blocks.CYAN_STAINED_GLASS));
    public static final Block PURPLE_BEVELED_GLASS = register("purple_beveled_glass", registerStainedGlass(DyeColor.PURPLE, Blocks.PURPLE_STAINED_GLASS));
    public static final Block BLUE_BEVELED_GLASS = register("blue_beveled_glass", registerStainedGlass(DyeColor.BLUE, Blocks.BLUE_STAINED_GLASS));
    public static final Block BROWN_BEVELED_GLASS = register("brown_beveled_glass", registerStainedGlass(DyeColor.BROWN, Blocks.BROWN_STAINED_GLASS));
    public static final Block GREEN_BEVELED_GLASS = register("green_beveled_glass", registerStainedGlass(DyeColor.GREEN, Blocks.GREEN_STAINED_GLASS));
    public static final Block RED_BEVELED_GLASS = register("red_beveled_glass", registerStainedGlass(DyeColor.RED, Blocks.RED_STAINED_GLASS));
    public static final Block BLACK_BEVELED_GLASS = register("black_beveled_glass", registerStainedGlass(DyeColor.BLACK, Blocks.BLACK_STAINED_GLASS));
    public static final Block RAINBOW_BEVELED_GLASS = register("rainbow_beveled_glass", registerStainedGlass(DyeColor.YELLOW, RAINBOW_GLASS));
    ...
    public static final Block WHITE_BEVELED_GLASS_PANE = register("white_beveled_glass_pane", registerStainedGlassPane(DyeColor.WHITE, Blocks.WHITE_STAINED_GLASS_PANE));
    public static final Block ORANGE_BEVELED_GLASS_PANE = register("orange_beveled_glass_pane", registerStainedGlassPane(DyeColor.ORANGE, Blocks.ORANGE_STAINED_GLASS_PANE));
    public static final Block MAGENTA_BEVELED_GLASS_PANE = register("magenta_beveled_glass_pane", registerStainedGlassPane(DyeColor.MAGENTA, Blocks.MAGENTA_STAINED_GLASS_PANE));
    public static final Block LIGHT_BLUE_BEVELED_GLASS_PANE = register("light_blue_beveled_glass_pane", registerStainedGlassPane(DyeColor.LIGHT_BLUE, Blocks.LIGHT_BLUE_STAINED_GLASS_PANE));
    public static final Block YELLOW_BEVELED_GLASS_PANE = register("yellow_beveled_glass_pane", registerStainedGlassPane(DyeColor.YELLOW, Blocks.YELLOW_STAINED_GLASS_PANE));
    public static final Block LIME_BEVELED_GLASS_PANE = register("lime_beveled_glass_pane", registerStainedGlassPane(DyeColor.LIME, Blocks.LIME_STAINED_GLASS_PANE));
    public static final Block PINK_BEVELED_GLASS_PANE = register("pink_beveled_glass_pane", registerStainedGlassPane(DyeColor.PINK, Blocks.PINK_STAINED_GLASS_PANE));
    public static final Block LIGHT_GRAY_BEVELED_GLASS_PANE = register("light_gray_beveled_glass_pane", registerStainedGlassPane(DyeColor.LIGHT_GRAY, Blocks.LIGHT_GRAY_STAINED_GLASS_PANE));
    public static final Block GRAY_BEVELED_GLASS_PANE = register("gray_beveled_glass_pane", registerStainedGlassPane(DyeColor.GRAY, Blocks.GRAY_STAINED_GLASS_PANE));
    public static final Block CYAN_BEVELED_GLASS_PANE = register("cyan_beveled_glass_pane", registerStainedGlassPane(DyeColor.CYAN, Blocks.CYAN_STAINED_GLASS_PANE));
    public static final Block PURPLE_BEVELED_GLASS_PANE = register("purple_beveled_glass_pane", registerStainedGlassPane(DyeColor.PURPLE, Blocks.PURPLE_STAINED_GLASS_PANE));
    public static final Block BLUE_BEVELED_GLASS_PANE = register("blue_beveled_glass_pane", registerStainedGlassPane(DyeColor.BLUE, Blocks.BLUE_STAINED_GLASS_PANE));
    public static final Block BROWN_BEVELED_GLASS_PANE = register("brown_beveled_glass_pane", registerStainedGlassPane(DyeColor.BROWN, Blocks.BROWN_STAINED_GLASS_PANE));
    public static final Block GREEN_BEVELED_GLASS_PANE = register("green_beveled_glass_pane", registerStainedGlassPane(DyeColor.GREEN, Blocks.GREEN_STAINED_GLASS_PANE));
    public static final Block RED_BEVELED_GLASS_PANE = register("red_beveled_glass_pane", registerStainedGlassPane(DyeColor.RED, Blocks.RED_STAINED_GLASS_PANE));
    public static final Block BLACK_BEVELED_GLASS_PANE = register("black_beveled_glass_pane", registerStainedGlassPane(DyeColor.BLACK, Blocks.BLACK_STAINED_GLASS_PANE));
    public static final Block RAINBOW_BEVELED_GLASS_PANE = register("rainbow_beveled_glass_pane", registerStainedGlassPane(DyeColor.YELLOW, RAINBOW_GLASS_PANE));
    ...
    // Pressure Plates
    public static final Block POLISHED_ANDESITE_PRESSURE_PLATE = register("polished_andesite_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, Blocks.POLISHED_ANDESITE));
    public static final Block POLISHED_DIORITE_PRESSURE_PLATE = register("polished_diorite_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, Blocks.POLISHED_DIORITE));
    public static final Block POLISHED_GRANITE_PRESSURE_PLATE = register("polished_granite_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, Blocks.POLISHED_GRANITE));
    public static final Block LIMESTONE_PRESSURE_PLATE = register("limestone_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, LIMESTONE));
    public static final Block MARBLE_PRESSURE_PLATE = register("marble_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, MARBLE));
    public static final Block BLUESTONE_PRESSURE_PLATE = register("bluestone_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, BLUESTONE));
    public static final Block POLISHED_NETHERRACK_PRESSURE_PLATE = register("polished_netherrack_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, POLISHED_NETHERRACK));
    public static final Block POLISHED_END_STONE_PRESSURE_PLATE = register("polished_end_stone_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, POLISHED_END_STONE));
    public static final Block BAMBOO_PRESSURE_PLATE = register("bamboo_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.EVERYTHING, BAMBOO_PLANKS));
    public static final Block CHARRED_PRESSURE_PLATE = register("charred_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.EVERYTHING, CHARRED_PLANKS));
    public static final Block WHITE_OAK_PRESSURE_PLATE = register("white_oak_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.EVERYTHING, WHITE_OAK_PLANKS));
    public static final Block POLISHED_BASALT_PRESSURE_PLATE = register("polished_basalt_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, Blocks.POLISHED_BASALT));
    public static final Block POLISHED_DEEPSLATE_PRESSURE_PLATE = register("polished_deepslate_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, Blocks.POLISHED_DEEPSLATE));
    public static final Block POLISHED_TUFF_PRESSURE_PLATE = register("polished_tuff_pressure_plate", registerPressurePlate(PressurePlateBlock.ActivationRule.MOBS, POLISHED_TUFF));
    ...
    public static final Block BAMBOO_BUTTON = register("bamboo", new WoodenButtonBase(FabricBlockSettings.copy(Blocks.OAK_PLANKS).noCollision()));
    public static final Block CHARRED_BUTTON = register("charred", new WoodenButtonBase(FabricBlockSettings.copy(CHARRED_PLANKS).noCollision()));
    public static final Block WHITE_OAK_BUTTON = register("white_oak", new WoodenButtonBase(FabricBlockSettings.copy(WHITE_OAK_PLANKS).noCollision()));
    ...
    public static final Block PAPER_WALL = register("paper_wall", registerWoodenPane());
    public static final Block PAPER_DOOR = register("paper_door", registerDoor(0.1f, 0.8f, Material.WOOD, BlockSoundGroup.WOOD, MapColor.OFF_WHITE));
    public static final Block PAPER_TRAPDOOR = register("paper_trapdoor", registerTrapdoor(0.1f, 0.8f, Material.WOOD, BlockSoundGroup.WOOD, MapColor.OFF_WHITE));
    ...
    // Gates - chains - bars
    public static final Block IRON_GATE = register("iron_gate", new Block(FabricBlockSettings.copy(Blocks.IRON_DOOR)));
    public static final Block GOLDEN_GATE = register("golden_gate", new Block(FabricBlockSettings.copy(Blocks.IRON_DOOR)));
    public static final Block GOLDEN_BARS = register("golden_bars", new Block(FabricBlockSettings.copy(Blocks.IRON_BARS)));
    public static final Block GOLDEN_CHAIN = register("golden_chain", new Block(FabricBlockSettings.copy(Blocks.CHAIN)));
    ...
    // Barriers
    public static final Block CAUTION_BARRIER_BLOCK = register("caution_barrier", registerBarrier(1.5f, 1200.0f));
    public static final Block ROAD_BARRIER_BLOCK = register("road_barrier", registerBarrier(2f, 6.0f));
    ...
    public static final Block SUGAR_BLOCK = register("sugar_block", registerFallingBlock(0.5f, 0.5f, Material.AGGREGATE, BlockSoundGroup.SAND, MapColor.OFF_WHITE));
    ...
    public static final Block WOODEN_FRAME = register("wooden_frame", registerWoodenPane());
    ...
    public static final Block WEIGHT_STORAGE_CUBE = register("weight_storage_cube", registerFallingBlock(0.1f, 6.0f, Material.STONE, BlockSoundGroup.STONE, MapColor.IRON_GRAY));
    public static final Block COMPANION_CUBE = register("companion_cube", registerFallingBlock(0.1f, 6.0f, Material.STONE, BlockSoundGroup.STONE, MapColor.IRON_GRAY));
    ...
    public static final Block LEGACY_GLOWING_OBSIDIAN = register("legacy_glowing_obsidian", registerLightBlock(50.0F, 1200.0F, Material.STONE, BlockSoundGroup.STONE, 12, MapColor.BLACK));

...
public class StoneRelated {
	...
	public static final GlazedLikeBlockBase POLISHED_BLACKSTONE_CIRCLE_PAVEMENT = new GlazedLikeBlockBase("polished_blackstone_circle_pavement", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0);

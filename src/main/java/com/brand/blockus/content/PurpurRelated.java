...
public class PurpurRelated {
	...
	public static void init() {
		...
		SMOOTH_PURPUR = new BlockBase("smooth_purpur", 1.5f, 30.0f);
		PURPUR_SQUARES = new BlockBase("purpur_squares", 1.5f, 30.0f);
		PURPUR_LITTLE_BRICKS = new BlockBase("purpur_little_bricks", 1.5f, 30.0f);
		CHISELED_PURPUR = new BlockBase("chiseled_purpur", 1.5f, 30.0f);
		PURPUR_LINES = new PillarBase("purpur_lines", 1.5f, 30.0f);

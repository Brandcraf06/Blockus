...
public static BlockBase ZIGZAGGED_END_STONE_BRICKS;
    ...
    CHISELED_END_STONE_BRICKS = new BlockBase("chiseled_end_stone_bricks", 0.8f, 4.0f);
    ZIGZAGGED_END_STONE_BRICKS = new BlockBase("zigzagged_end_stone_bricks", 0.8f, 4.0f);

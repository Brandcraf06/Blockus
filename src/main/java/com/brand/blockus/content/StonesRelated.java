...
public class StonesRelated {
    ...
    public static final PlayerFacingBlockBase STONE_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("stone_circle_pavement", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MaterialColor.STONE);
    ...
    public static final PlayerFacingBlockBase ANDESITE_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("andesite_circle_pavement", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MaterialColor.STONE);
    ...
    public static final PlayerFacingBlockBase DIORITE_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("diorite_circle_pavement", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MaterialColor.QUARTZ);
    ...
    public static final PlayerFacingBlockBase GRANITE_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("granite_circle_pavement", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MaterialColor.DIRT);
    ...
    public static final PlayerFacingBlockBase POLISHED_BLACKSTONE_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("polished_blackstone_circle_pavement", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 0, MaterialColor.BLACK);

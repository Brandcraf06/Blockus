...
public class Rainbow {
    ...
    public static final PillarBase RAINBOW_BLOCK = new PillarBase("rainbow_block", 5.0f, 6.0f, Material.STONE, BlockSoundGroup.STONE, MaterialColor.LIGHT_BLUE);
    public static final BlockBase RAINBOW_BRICKS = new BlockBase("rainbow_bricks", 1.5f, 6.0f, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, MaterialColor.QUARTZ);
    ...
    public static final LightBlockBase RAINBOW_LAMP_LIT = new LightBlockBase("rainbow_lamp_lit", 0.3f, 0.3f, Material.REDSTONE_LAMP, BlockSoundGroup.GLASS, Blockus.BLOCKUS_DECORATIONS, 15, MaterialColor.CLEAR);

...
public class NewWoods {
    ...
    public static final PillarBaseBT WHITE_OAK_LOG = new PillarBaseBT("white_oak_log", 2.0f, 2.0f, Material.WOOD, BlockSoundGroup.WOOD, FabricToolTags.AXES, 0, MaterialColor.LIGHT_GRAY_TERRACOTTA);
    public static final PillarBaseBT STRIPPED_WHITE_OAK_LOG = new PillarBaseBT("stripped_white_oak_log", 2.0f, 2.0f, Material.WOOD, BlockSoundGroup.WOOD, FabricToolTags.AXES, 0, MaterialColor.LIGHT_GRAY_TERRACOTTA);
    public static final PillarBaseBT WHITE_OAK_WOOD = new PillarBaseBT("white_oak_wood", 2.0f, 2.0f, Material.WOOD, BlockSoundGroup.WOOD, FabricToolTags.AXES, 0, MaterialColor.LIGHT_GRAY_TERRACOTTA);
    public static final PillarBaseBT STRIPPED_WHITE_OAK_WOOD = new PillarBaseBT("stripped_white_oak_wood", 2.0f, 2.0f, Material.WOOD, BlockSoundGroup.WOOD, FabricToolTags.AXES, 0, MaterialColor.LIGHT_GRAY_TERRACOTTA);

...
public class ObsidianRelated {
    ...
    public static final BlockBaseRT OBSIDIAN_BRICKS = new BlockBaseRT("obsidian_bricks", 50.0F, 1200.0F, Material.STONE, BlockSoundGroup.STONE, Blockus.BLOCKUS_BUILDING_BLOCKS, FabricToolTags.PICKAXES, 3, MaterialColor.BLACK);
    ...
    public static final PillarBaseRT OBSIDIAN_PILLAR = new PillarBaseRT("obsidian_pillar", 50.0F, 1200.0F, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 3, MaterialColor.BLACK);
    public static final PlayerFacingBlockBase OBSIDIAN_CIRCLE_PAVEMENT = new PlayerFacingBlockBase("obsidian_circle_pavement", 50.0F, 1200.0F, Material.STONE, BlockSoundGroup.STONE, FabricToolTags.PICKAXES, 3, MaterialColor.BLACK);

...
public class BlockusWorldgenProvider extends FabricDynamicRegistryProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries, FabricDynamicRegistryProvider.Entries entries) {
        ...
        PlacedFeature PLACED_WHITE_OAK = new PlacedFeature(whiteOak, List.of(new PlacementModifier[]{PlacedFeatures.createCountExtraModifier(0, 0.04F, 1), SquarePlacementModifier.of(), SurfaceWaterDepthFilterPlacementModifier.of(0), PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of(), BlockFilterPlacementModifier.of(BlockPredicate.wouldSurvive(BlockusBlocks.WHITE_OAK_SAPLING.getDefaultState(), BlockPos.ORIGIN))}));
        entries.add(BlockusWorldgenFeatures.PLACED_WHITE_OAK, PLACED_WHITE_OAK);

        PlacedFeature PLACED_WHITE_OAK_RARE = new PlacedFeature(whiteOak, List.of(new PlacementModifier[]{PlacedFeatures.createCountExtraModifier(0, 0.0125F, 1), SquarePlacementModifier.of(), SurfaceWaterDepthFilterPlacementModifier.of(0), PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of(), BlockFilterPlacementModifier.of(BlockPredicate.wouldSurvive(BlockusBlocks.WHITE_OAK_SAPLING.getDefaultState(), BlockPos.ORIGIN))}));

...
public class BlockusWorldgenFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> WHITE_OAK_LEAF_LITTER = configured("white_oak_leaf_litter");
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> FALLEN_WHITE_OAK = configured("fallen_white_oak");
    public static final RegistryKey<PlacedFeature> PLACED_FALLEN_WHITE_OAK = placed("fallen_white_oak");
    ...
    public static void registerConfiguredFeature() {
        ...
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.FOREST, BiomeKeys.DARK_FOREST, BiomeKeys.FLOWER_FOREST), GenerationStep.Feature.VEGETAL_DECORATION, PLACED_FALLEN_WHITE_OAK);

...
public class BlockBase2 extends Block {
	...
	public BlockBase2(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, ItemGroup itemgroup, Tag<Item> tag, int mininglevel) {

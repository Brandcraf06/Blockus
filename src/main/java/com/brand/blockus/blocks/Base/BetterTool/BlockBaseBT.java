...
public class BlockBaseBT extends Block {
    ...
    public BlockBaseBT(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, ItemGroup itemgroup, Tag<Item> tag, int mininglevel, MapColor color) {

...
public class OrientableBlockBase extends HorizontalFacingBlock {
    ...
    public OrientableBlockBase(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, Tag<Item> tag, int mininglevel, MaterialColor color) {

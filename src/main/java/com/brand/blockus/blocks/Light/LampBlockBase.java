...
public class LampBlockBase extends Block {
	...
	public LampBlockBase(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, ItemGroup itemgroup, int luminance, MapColor color) {

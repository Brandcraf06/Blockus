...
public class WoodenButtonBase extends WoodenButtonBlock {

    public WoodenButtonBase(String name) {
        super(FabricBlockSettings.of(Material.SUPPORTED).sounds(BlockSoundGroup.WOOD).breakByTool(FabricToolTags.AXES, 0).noCollision().strength(0.5f));

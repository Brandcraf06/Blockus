...
public class LegacyLeavesBlock extends Block {
	...
	public LegacyLeavesBlock(String name, float hardness, float resistance) {
		super(FabricBlockSettings.of(Material.LEAVES).sounds(BlockSoundGroup.GRASS).breakByTool(FabricToolTags.SHEARS, 0).strength(hardness, resistance).nonOpaque().build());

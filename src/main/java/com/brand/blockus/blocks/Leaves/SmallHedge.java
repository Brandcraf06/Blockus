...
public class SmallHedge extends HedgeBlock {
	...
	public SmallHedge(String name, float hardness, float resistance) {
		super(FabricBlockSettings.of(Material.LEAVES).sounds(BlockSoundGroup.GRASS).breakByTool(FabricToolTags.HOES, 0).breakByTool(FabricToolTags.SHEARS, 0).strength(hardness, resistance).build());

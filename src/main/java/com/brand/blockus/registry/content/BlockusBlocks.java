...
public class BlockusBlocks extends BlockFactory {
    ...
    public static final Block RAINBOW_PETALS = registerOf("rainbow_petals", FlowerbedBlock::new, create().mapColor(MapColor.DARK_GREEN).noCollision().sounds(BlockSoundGroup.PINK_PETALS).pistonBehavior(PistonBehavior.DESTROY));
    ...
    public static final Block WHITE_OAK_LEAVES = registerCopy("white_oak_leaves", LeavesBlock::new, Blocks.OAK_LEAVES, settings -> settings.mapColor(MapColor.ORANGE).pistonBehavior(PistonBehavior.DESTROY).allowsSpawning(BlockusBlocks::canSpawnOnLeaves).suffocates(BlockusBlocks::never).blockVision(BlockusBlocks::never));
    public static final WoodBundle WHITE_OAK = WoodBundle.of("white_oak", Blocks.OAK_PLANKS, MapColor.OFF_WHITE, BlockSoundGroup.WOOD, WoodType.OAK, BlockSetType.OAK, true).register();
    ...
    // Charred
    public static final WoodBundle CHARRED = WoodBundle.of("charred", Blocks.OAK_PLANKS, MapColor.TERRACOTTA_GRAY, BlockSoundGroup.WOOD, WoodType.OAK, BlockSetType.OAK, false).register();

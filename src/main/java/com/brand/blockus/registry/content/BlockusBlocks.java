...
public class BlockusBlocks extends BlockFactory {
    ...
    // Rainbow
    public static final Block RAINBOW_ROSE = registerOf("rainbow_rose", settings -> new FertilizableFlowerBlock(MobEffects.GLOWING, 8, settings), create().mapColor(MapColor.PLANT).noCollission().instabreak().pushReaction(PushReaction.DESTROY).sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
    public static final Block RAINBOW_PETALS = registerOf("rainbow_petals", PinkPetalsBlock::new, create().mapColor(MapColor.PLANT).noCollission().sound(SoundType.PINK_PETALS).pushReaction(PushReaction.DESTROY));
    ...
    // White Oak Wood
    public static final Block WHITE_OAK_SAPLING = registerCopy("white_oak_sapling", settings -> new SaplingBlock(BlockusTreeGrower.WHITE_OAK, settings), Blocks.OAK_SAPLING, settings -> settings.pushReaction(PushReaction.DESTROY));
    ...
    public static final Block WHITE_OAK_LEAVES = registerCopy("white_oak_leaves", LeavesBlock::new, Blocks.OAK_LEAVES, settings -> settings.mapColor(MapColor.COLOR_ORANGE).pushReaction(PushReaction.DESTROY).isValidSpawn(BlockusBlocks::canSpawnOnLeaves).isSuffocating(BlockusBlocks::never).isViewBlocking(BlockusBlocks::never));
    public static final WoodBundle WHITE_OAK = WoodBundle.of("white_oak", Blocks.OAK_PLANKS, MapColor.QUARTZ, SoundType.WOOD, WoodType.OAK, BlockSetType.OAK, true).register();
    ...
    // Charred
    public static final WoodBundle CHARRED = WoodBundle.of("charred", Blocks.OAK_PLANKS, MapColor.TERRACOTTA_GRAY, SoundType.WOOD, WoodType.OAK, BlockSetType.OAK, false).register();
    ...
    // Legacy
    public static final Block LEGACY_SAPLING = registerLegacy("legacy_sapling", settings -> new SaplingBlock(BlockusTreeGrower.LEGACY_OAK, settings), createCopy(Blocks.OAK_SAPLING), "Indev");
    ...
    public static final Block LEGACY_LEAVES = registerLegacy("legacy_leaves", LeavesBlock::new, createCopy(Blocks.OAK_LEAVES).mapColor(MapColor.COLOR_LIGHT_GREEN).isValidSpawn(BlockusBlocks::canSpawnOnLeaves).isSuffocating(BlockusBlocks::never).isViewBlocking(BlockusBlocks::never), "Classic 0.0.15a");

...
public class BlockusEntities {
    ...
    public static final ResourceLocation WHITE_OAK_BOATS_ID = Blockus.id("white_oak");
    public static final ResourceLocation CHARRED_BOATS_ID = Blockus.id("charred");
    public static final ResourceLocation RAW_BAMBOO_RAFTS_ID = Blockus.id("raw_bamboo");

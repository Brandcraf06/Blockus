...
public class BlockusConfiguredFeatures {
    ...
    static {
        LIMESTONE = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, BlockusBlocks.LIMESTONE.getDefaultState(), 64)).uniformRange(YOffset.fixed(32), YOffset.fixed(128)).spreadHorizontally().repeat(2);

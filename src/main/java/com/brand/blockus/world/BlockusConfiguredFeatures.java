...
public class BlockusConfiguredFeatures {
    ...
    public static void registerConfiguredFeature() {
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, Blockus.id("ore_marble"), ORE_MARBLE);
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, Blockus.id("ore_bluestone"), ORE_BLUESTONE);

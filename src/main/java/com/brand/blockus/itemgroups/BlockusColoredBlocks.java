...
public class BlockusColoredBlocks {

    private static final RegistryKey<ItemGroup> BLOCKUS_COLORED_BLOCKS = RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(Blockus.MOD_ID, "blockus_colored"));

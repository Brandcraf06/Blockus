...
public class BlockusBuildingBlocks {
    ...
    private static final RegistryKey<ItemGroup> BLOCKUS_BUILDING_BLOCKS = RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(Blockus.MOD_ID, "blockus_building_blocks"));

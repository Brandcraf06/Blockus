    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registriesFuture, RecipeOutput output) {
        return new RecipeProvider(registriesFuture, output) {
            ...
            public void buildRecipes() {
                ...
                shaped(RecipeCategory.BUILDING_BLOCKS, BLUESTONE.block(), 4).define('S', Blocks.STONE).define('#', Items.DYE.blue()).pattern(" S ").pattern("S#S").pattern(" S ").unlockedBy(getHasName(Items.DYE.blue()), has(Items.DYE.blue())).unlockedBy(getHasName(Blocks.STONE), has(Blocks.STONE)).save(output);
                ...
                for (CopperBSSWBundle bundle : CopperBSSWBundle.values()) {
                    for (WeatheringCopper.WeatherState state : WeatheringCopper.WeatherState.values()) {
                        waxingRecipes(bundle.block().blocks().weathering().pick(state), bundle.block().blocks().waxed().pick(state));
                        waxingRecipes(bundle.slab().blocks().weathering().pick(state), bundle.slab().blocks().waxed().pick(state));
                        waxingRecipes(bundle.stairs().blocks().weathering().pick(state), bundle.stairs().blocks().waxed().pick(state));
                        waxingRecipes(RecipeCategory.DECORATIONS, bundle.wall().blocks().weathering().pick(state), bundle.wall().blocks().waxed().pick(state));
                    }
                }
                ...
                hedge(RED_POPLAR_HEDGE, Blocks.RED_POPLAR_LEAVES);
                hedge(ORANGE_POPLAR_HEDGE, Blocks.ORANGE_POPLAR_LEAVES);
                hedge(YELLOW_POPLAR_HEDGE, Blocks.YELLOW_POPLAR_LEAVES);
                ...
                for (DyeColor color : DyeColor.values()) {
                    ...
                    dyedStoneBricks(Items.DYE.pick(color), dyedStoneBricks.block().blocks().pick(color), dyedStoneBricks.stairs().blocks().pick(color), dyedStoneBricks.slab().blocks().pick(color), dyedStoneBricks.wall().blocks().pick(color));
                    dyedShingles(Items.DYE.pick(color), Blocks.DYED_TERRACOTTA.pick(color), dyedShingles.block().blocks().pick(color), dyedShingles.stairs().blocks().pick(color), dyedShingles.slab().blocks().pick(color));
                    concreteBricks(Blocks.CONCRETE.pick(color), concreteBricks.block().blocks().pick(color), concreteBricks.stairs().blocks().pick(color), concreteBricks.slab().blocks().pick(color), concreteBricks.wall().blocks().pick(color), concreteBricks.chiseled().blocks().pick(color), concreteBricks.pillar().blocks().pick(color));
                }
                ...
                CollectionUtils.zipApply(DYED_REDSTONE_LAMP.blocks(), Items.DYE, DYED_LIT_REDSTONE_LAMP.blocks(), this::stainedRedstoneLamp);
                stainedRedstoneLamp(RAINBOW_LAMP, RAINBOW_PETALS, LIT_RAINBOW_LAMP);

                // Neon Blocks
                ColorCollection.zipApply(NEON.blocks(), Items.DYE, this::neon);
                neon(RAINBOW_NEON, RAINBOW_PETALS);

                // Futurneo Blocks
                ColorCollection.zipApply(FUTURNEO_BLOCK.blocks(), Blocks.STAINED_GLASS, this::futurneo);
                shaped(RecipeCategory.BUILDING_BLOCKS, GRAY_BRIGHT_FUTURNEO_BLOCK).define('A', Items.DYE.white()).define('B', Blocks.STAINED_GLASS.gray()).define('C', Blocks.TORCH).pattern("ABA").pattern("BCB").pattern("ABA").group("futurneo_blocks").unlockedBy(getHasName(Blocks.STAINED_GLASS.gray()), has(Blocks.STAINED_GLASS.gray())).save(output);
                futurneo(RAINBOW_FUTURNEO_BLOCK, RAINBOW_GLASS);

                // Asphalt
                for (DyeColor color : DyeColor.values()) {
                    AsphaltBundle block = ASPHALT;
                    blockStairsSlab(block.block().blocks().pick(color), block.stairs().blocks().pick(color), block.slab().blocks().pick(color));
                    stonecuttingRecipe(block.stairs().blocks().pick(color), block.block().blocks().pick(color));
                    stonecuttingRecipe(block.slab().blocks().pick(color), 2, block.block().blocks().pick(color));
                    if (color != DyeColor.BLACK) {
                        asphalt(Items.DYE.pick(color), block.block().blocks().pick(color), block.stairs().blocks().pick(color), block.slab().blocks().pick(color));
                    }
                }
                shaped(RecipeCategory.BUILDING_BLOCKS, ASPHALT.block().blocks().black(), 8).define('X', Blocks.GRAVEL).define('#', ItemTags.COALS).pattern("XXX").pattern("X#X").pattern("XXX").group("asphalt").unlockedBy(getHasName(Blocks.GRAVEL), has(Blocks.GRAVEL)).save(output);
                enclosedRecipeToEight(RAINBOW_ASPHALT, Ingredient.of(ASPHALT.block().blocks().black()), RAINBOW_PETALS).unlockedBy(getHasName(ASPHALT.block().blocks().black()), has(ASPHALT.block().blocks().black())).save(output);

                // Wool
                for (DyeColor color : DyeColor.values()) {
                    patternedWool(PATTERNED_WOOL.block().blocks().pick(color), Blocks.WOOL.pick(color), PATTERNED_WOOL.carpet().blocks().pick(color), Blocks.CARPET.pick(color));
                    ginghamWool(GINGHAM_WOOL.block().blocks().pick(color), Blocks.WOOL.pick(color));
                ...
                CollectionUtils.zipApply(STAINED_BEVELED_GLASS.blocks(), STAINED_BEVELED_GLASS_PANE.blocks(), Blocks.STAINED_GLASS, Items.DYE, this::stainedBeveledGlass);
                ...
                // Colored Tiles
                ColorCollection.zipApply(COLORED_TILES.blocks(), Blocks.CONCRETE, this::unicolorColoredTiles);
                unicolorColoredTiles(RAINBOW_COLORED_TILES, RAINBOW_BLOCK);

                // Glazed Terracotta Pillars
                ColorCollection.zipApply(GLAZED_TERRACOTTA_PILLAR.blocks(), Blocks.GLAZED_TERRACOTTA, this::pillar);
                ...
                door(COPPER_GATE.blocks().weathering().unaffected(), Blocks.COPPER_BARS.weathering().unaffected());
                door(COPPER_GATE.blocks().weathering().exposed(), Blocks.COPPER_BARS.weathering().exposed());
                door(COPPER_GATE.blocks().weathering().weathered(), Blocks.COPPER_BARS.weathering().weathered());
                door(COPPER_GATE.blocks().weathering().oxidized(), Blocks.COPPER_BARS.weathering().oxidized());
                door(COPPER_GATE.blocks().waxed().unaffected(), Blocks.COPPER_BARS.waxed().unaffected());
                door(COPPER_GATE.blocks().waxed().exposed(), Blocks.COPPER_BARS.waxed().exposed());
                door(COPPER_GATE.blocks().waxed().weathered(), Blocks.COPPER_BARS.waxed().weathered());
                door(COPPER_GATE.blocks().waxed().oxidized(), Blocks.COPPER_BARS.waxed().oxidized());
                ...
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().weathering().unaffected(), Blocks.COPPER_LANTERN.weathering().unaffected(), Items.COPPER_NUGGET);
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().weathering().exposed(), Blocks.COPPER_LANTERN.weathering().exposed(), Items.COPPER_NUGGET);
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().weathering().weathered(), Blocks.COPPER_LANTERN.weathering().weathered(), Items.COPPER_NUGGET);
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().weathering().oxidized(), Blocks.COPPER_LANTERN.weathering().oxidized(), Items.COPPER_NUGGET);
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().waxed().unaffected(), Blocks.COPPER_LANTERN.waxed().unaffected(), Items.COPPER_NUGGET);
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().waxed().exposed(), Blocks.COPPER_LANTERN.waxed().exposed(), Items.COPPER_NUGGET);
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().waxed().weathered(), Blocks.COPPER_LANTERN.waxed().weathered(), Items.COPPER_NUGGET);
                lanternBlockRecipe(COPPER_LANTERN_BLOCK.blocks().waxed().oxidized(), Blocks.COPPER_LANTERN.waxed().oxidized(), Items.COPPER_NUGGET);
                ...
                shaped(RecipeCategory.BUILDING_BLOCKS, LOVE_BLOCK).define('M', Items.DYE.magenta()).define('R', Items.DYE.red()).pattern("RMR").pattern("RRR").pattern("MRM").unlockedBy(getHasName(Items.DYE.magenta()), has(Items.DYE.magenta())).unlockedBy(getHasName(Items.DYE.red()), has(Items.DYE.red())).save(output);
                ...
                shaped(RecipeCategory.BUILDING_BLOCKS, CAUTION_BLOCK, 6).define('A', Blocks.STONE).define('B', Items.DYE.black()).define('C', Items.DYE.yellow()).pattern(" C ").pattern("BAB").pattern(" C ").unlockedBy(getHasName(Items.DYE.black()), has(Items.DYE.black())).unlockedBy(getHasName(Items.DYE.yellow()), has(Items.DYE.yellow())).save(output);
            ...
            public void hangingSign(ItemLike result, ItemLike input) {
                hangingSignBuilder(result, Ingredient.of(input)).unlockedBy(getHasName(input), has(input)).save(output);
            }
            ...
            public void copperBricks() {
                ...
                CollectionUtils.zipApply(COPPER_BRICKS.block().blocks(), COPPER_BRICKS.stairs().blocks(), COPPER_BRICKS.slab().blocks(), Blocks.CUT_COPPER, (block, stairs, slab, cutBlock) -> {
                    ...
                    twoByTwoToFour(block, cutBlock);
                });
                CollectionUtils.zipApply(Blocks.COPPER_BLOCK, Blocks.CUT_COPPER, COPPER_BRICKS.wall().blocks(), (base, cutBlock, wall) -> {
                    this.stonecutterResultFromBase(RecipeCategory.DECORATIONS, wall, base, 4);
                    this.stonecutterResultFromBase(RecipeCategory.DECORATIONS, wall, cutBlock);
                });
            }
            ...
            public void asphalt(ItemLike dye, ItemLike block, ItemLike stairs, ItemLike slab) {
                enclosedRecipeToEight(block, Ingredient.of(ASPHALT.block().blocks().black()), dye).group("asphalt").unlockedBy(getHasName(ASPHALT.block().blocks().black()), has(ASPHALT.block().blocks().black())).save(output);
                enclosedRecipeToEight(stairs, Ingredient.of(ASPHALT.stairs().blocks().black()), dye).group("asphalt_stairs").unlockedBy(getHasName(ASPHALT.stairs().blocks().black()), has(ASPHALT.stairs().blocks().black())).save(output, getConversionRecipeName(stairs, ASPHALT.stairs().blocks().black()));
                enclosedRecipeToEight(slab, Ingredient.of(ASPHALT.slab().blocks().black()), dye).group("asphalt_slab").unlockedBy(getHasName(ASPHALT.slab().blocks().black()), has(ASPHALT.slab().blocks().black())).save(output, getConversionRecipeName(slab, ASPHALT.slab().blocks().black()));
            }

            public void colorItemWithRainbow(ItemLike dyedItem, List<Item> sourceItems, @Nullable String group, RecipeCategory category) {
                shapeless(category, dyedItem).requires(RAINBOW_PETALS.asItem()).requires(Ingredient.of(sourceItems.stream())).group(group).unlockedBy(getHasName(RAINBOW_PETALS.asItem()), has(RAINBOW_PETALS.asItem())).save(output, getItemName(dyedItem) + "_from_rainbow_petals");
            }
            ...
            public void futurneo(ItemLike result, ItemLike glass) {
                shaped(RecipeCategory.BUILDING_BLOCKS, result, 6).define('A', Items.DYE.black()).define('B', glass).define('C', Blocks.TORCH).pattern("ABA").pattern("BCB").pattern("ABA").group("futurneo_blocks").unlockedBy(getHasName(glass), has(glass)).save(output);
            }

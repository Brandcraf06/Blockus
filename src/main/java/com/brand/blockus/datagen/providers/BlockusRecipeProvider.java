...
public class BlockusRecipeProvider extends FabricRecipeProvider {
    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registriesFuture, RecipeOutput exporter) {
        return new RecipeProvider(registriesFuture, exporter) {
            ...
            public void buildRecipes() {
                ...
                for (CopperBSSWBundle bundle : CopperBSSWBundle.values()) {
                    for (WeatheringCopper.WeatherState state : WeatheringCopper.WeatherState.values()) {
                        ...
                        offerWaxingRecipes(RecipeCategory.DECORATIONS, bundle.wall().blocks().weathering().pick(state), bundle.wall().blocks().waxed().pick(state));
                    }
                }
                ...
                SimpleCookingRecipeBuilder.smelting(tag(BlockusItemTags.PLANKS_THAT_CAN_BE_CHARRED), RecipeCategory.BUILDING_BLOCKS, CookingBookCategory.BLOCKS, CHARRED.planks(), 0.1F, 200).unlockedBy("has_planks", has(BlockusItemTags.PLANKS_THAT_CAN_BE_CHARRED)).save(exporter);
                ...
                offerCharredSmeltingRecipe(BlockusItemTags.WOODEN_MOSAICS_THAT_CAN_BE_CHARRED, RecipeCategory.BUILDING_BLOCKS, WOODEN_MOSAIC.get(WoodMaps.CHARRED.getId()).block(), "mosaic");
                ...
                offerCharredSmeltingRecipe(BlockusItemTags.HERRINGBONE_PLANKS_THAT_CAN_BE_CHARRED, RecipeCategory.BUILDING_BLOCKS, HERRINGBONE_PLANKS.get(WoodMaps.CHARRED.getId()), "herringbone_planks");
                ...
                // Hedges
                offerHedgeRecipe(OAK_HEDGE, Blocks.OAK_LEAVES);
                offerHedgeRecipe(SPRUCE_HEDGE, Blocks.SPRUCE_LEAVES);
                offerHedgeRecipe(BIRCH_HEDGE, Blocks.BIRCH_LEAVES);
                offerHedgeRecipe(JUNGLE_HEDGE, Blocks.JUNGLE_LEAVES);
                offerHedgeRecipe(ACACIA_HEDGE, Blocks.ACACIA_LEAVES);
                offerHedgeRecipe(DARK_OAK_HEDGE, Blocks.DARK_OAK_LEAVES);
                ...
                offerHedgeRecipe(AZALEA_HEDGE, Blocks.AZALEA_LEAVES);
                offerHedgeRecipe(FLOWERING_AZALEA_HEDGE, Blocks.FLOWERING_AZALEA_LEAVES);
                offerHedgeRecipe(MOSS_HEDGE, Blocks.MOSS_BLOCK);
                offerHedgeRecipe(PALE_MOSS_HEDGE, Blocks.PALE_MOSS_BLOCK);
                ...
                shaped(RecipeCategory.DECORATIONS, BEVELED_GLASS_PANE, 16).define('#', BEVELED_GLASS).pattern("###").pattern("###").group("beveled_glass_pane").unlockedBy("has_beveled_glass", has(BEVELED_GLASS)).save(exporter);
                ...
                shapeless(RecipeCategory.REDSTONE, Items.REDSTONE, 8).requires(REDSTONE_SAND).unlockedBy(getHasName(REDSTONE_SAND), has(REDSTONE_SAND)).save(exporter, getConversionRecipeName(Items.REDSTONE, REDSTONE_SAND));
            ...
            public void offerHedgeRecipe(ItemLike output, ItemLike input) {
            ...
            public void offerDyedStoneBricksRecipe(ItemLike dye, ItemLike block, ItemLike stairs, ItemLike slab, ItemLike wall) {
                ...
                createEnclosedRecipe(RecipeCategory.DECORATIONS, wall, Ingredient.of(Blocks.STONE_BRICK_WALL), dye, 8).group("dyed_stone_brick_wall").unlockedBy(getHasName(Blocks.STONE_BRICKS), has(Blocks.STONE_BRICKS)).save(exporter, getConversionRecipeName(wall, Blocks.STONE_BRICK_WALL));
            ...
            public void offerConcreteBricksRecipe(ItemLike concrete, ItemLike block, ItemLike stairs, ItemLike slab, ItemLike wall, ItemLike chiseled, ItemLike pillar) {
                ...
                offerStonecuttingRecipe(RecipeCategory.DECORATIONS, wall, concrete, block);
            ...
            public void offerStainedBeveledGlassRecipe(ItemLike beveledGlass, ItemLike beveledGlassPane, ItemLike glass, ItemLike dye) {
                ...
                shaped(RecipeCategory.DECORATIONS, beveledGlassPane, 16).define('#', beveledGlass).pattern("###").pattern("###").group("beveled_glass_pane").unlockedBy("has_beveled_glass", has(beveledGlass)).save(exporter);
                createEnclosedRecipe(RecipeCategory.DECORATIONS, beveledGlassPane, Ingredient.of(BEVELED_GLASS_PANE), dye, 8).group("beveled_glass_pane_2").unlockedBy(getHasName(BEVELED_GLASS_PANE), has(BEVELED_GLASS_PANE)).save(exporter, getConversionRecipeName(beveledGlass, BEVELED_GLASS_PANE));
            }
            ...
            public void offerBSSWCuttingRecipe(BSSWBundle bsswBundle, ItemLike... ingredients) {
                ...
                if (bsswBundle.wall() != null) {
                    offerStonecuttingRecipe(RecipeCategory.DECORATIONS, bsswBundle.wall(), bsswBundle.block());
                }
            }

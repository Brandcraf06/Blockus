...
public class BlockusModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator modelGenerator) {
        ...
        // Copper
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.COPPER_BRICKS.block).family(BlockusFamilies.COPPER_BRICKS).same(BlockusBlocks.COPPER_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_COPPER_BRICKS);
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.EXPOSED_COPPER_BRICKS.block).family(BlockusFamilies.EXPOSED_COPPER_BRICKS).same(BlockusBlocks.EXPOSED_COPPER_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_EXPOSED_COPPER_BRICKS);
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.WEATHERED_COPPER_BRICKS.block).family(BlockusFamilies.WEATHERED_COPPER_BRICKS).same(BlockusBlocks.WEATHERED_COPPER_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_WEATHERED_COPPER_BRICKS);
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.OXIDIZED_COPPER_BRICKS.block).family(BlockusFamilies.OXIDIZED_COPPER_BRICKS).same(BlockusBlocks.OXIDIZED_COPPER_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_OXIDIZED_COPPER_BRICKS);
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.COPPER_TUFF_BRICKS.block).family(BlockusFamilies.COPPERED_TUFF_BRICKS).same(BlockusBlocks.COPPER_TUFF_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_COPPERED_TUFF_BRICKS);
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.EXPOSED_COPPER_TUFF_BRICKS.block).family(BlockusFamilies.EXPOSED_COPPERED_TUFF_BRICKS).same(BlockusBlocks.EXPOSED_COPPER_TUFF_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_EXPOSED_COPPERED_TUFF_BRICKS);
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.WEATHERED_COPPER_TUFF_BRICKS.block).family(BlockusFamilies.WEATHERED_COPPERED_TUFF_BRICKS).same(BlockusBlocks.WEATHERED_COPPER_TUFF_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_WEATHERED_COPPERED_TUFF_BRICKS);
        modelGenerator.registerCubeAllModelTexturePool(BlockusBlocks.OXIDIZED_COPPER_TUFF_BRICKS.block).family(BlockusFamilies.OXIDIZED_COPPERED_TUFF_BRICKS).same(BlockusBlocks.OXIDIZED_COPPER_TUFF_BRICKS.blockWaxed).family(BlockusFamilies.WAXED_OXIDIZED_COPPERED_TUFF_BRICKS);

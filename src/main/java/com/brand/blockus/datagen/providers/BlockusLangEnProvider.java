...
public class BlockusLangEnProvider extends FabricLanguageProvider {
    public BlockusLangEnProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(BlockusEffects.ASPHALT_SPRINT, "Asphalt Sprint");
        ...
        // Tuff
        addBssw(translationBuilder, BlockusBlocks.POLISHED_TUFF, "Polished Tuff");
        addBssw(translationBuilder, BlockusBlocks.TUFF_BRICKS, "Tuff Bricks");
        ...
        translationBuilder.add(BlockusBlocks.CHISELED_TUFF, "Chiseled Tuff");

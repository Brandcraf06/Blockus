...
public class BlockusModels {
    ...
    public static final Model TEMPLATE_SMALL_HEDGE_NOSIDE;
    public static final Model TEMPLATE_SMALL_HEDGE_NOSIDE_ALT;
    public static final Model TEMPLATE_SMALL_HEDGE_POST;
    public static final Model TEMPLATE_SMALL_HEDGE_SIDE;
    public static final Model TEMPLATE_SMALL_HEDGE_SIDE_ALT;
    ...
    static {
        ...
        TEMPLATE_SMALL_HEDGE_NOSIDE = createModel("template_small_hedge_noside", "_noside", BlockusTextureKey.HEDGE);
        TEMPLATE_SMALL_HEDGE_NOSIDE_ALT = createModel("template_small_hedge_noside_alt", "_noside_alt", BlockusTextureKey.HEDGE);
        TEMPLATE_SMALL_HEDGE_POST = createModel("template_small_hedge_post", "_post", BlockusTextureKey.HEDGE);
        TEMPLATE_SMALL_HEDGE_SIDE = createModel("template_small_hedge_side", "_side", BlockusTextureKey.HEDGE);
        TEMPLATE_SMALL_HEDGE_SIDE_ALT = createModel("template_small_hedge_side_alt", "_side_alt", BlockusTextureKey.HEDGE);

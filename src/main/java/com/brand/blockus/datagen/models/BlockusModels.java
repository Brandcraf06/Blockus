...
public class BlockusModels {
    ...
    public static final Model TEMPLATE_HEDGE_NOSIDE;
    public static final Model TEMPLATE_HEDGE_NOSIDE_ALT;
    public static final Model TEMPLATE_HEDGE_POST;
    ...
    static {
        ...
        TEMPLATE_HEDGE_NOSIDE = createModel("template_hedge_noside", "_noside", BlockusTextureKey.HEDGE);
        TEMPLATE_HEDGE_NOSIDE_ALT = createModel("template_hedge_noside_alt", "_noside_alt", BlockusTextureKey.HEDGE);
        TEMPLATE_HEDGE_POST = createModel("template_hedge_post", "_post", BlockusTextureKey.HEDGE);

...
public class BlockusBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries) {
        ...
        this.getOrCreateTagBuilder(BlockusBlockTags.ALL_MOSSY_PLANKS)
            ...
            .add(BlockusBlocks.MOSSY_RAW_BAMBOO_PLANKS.block)
            .add(BlockusBlocks.MOSSY_CRIMSON_PLANKS.block)
            .add(BlockusBlocks.MOSSY_WARPED_PLANKS.block)
            .add(BlockusBlocks.MOSSY_CHARRED_PLANKS.block)
            .add(BlockusBlocks.MOSSY_OAK_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_BIRCH_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_SPRUCE_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_JUNGLE_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_ACACIA_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_DARK_OAK_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_MANGROVE_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_CHERRY_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_BAMBOO_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_WHITE_OAK_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_RAW_BAMBOO_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_CRIMSON_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_WARPED_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_CHARRED_PLANKS.stairs)
            .add(BlockusBlocks.MOSSY_OAK_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_BIRCH_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_SPRUCE_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_JUNGLE_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_ACACIA_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_DARK_OAK_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_MANGROVE_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_CHERRY_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_BAMBOO_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_WHITE_OAK_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_RAW_BAMBOO_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_CRIMSON_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_WARPED_PLANKS.slab)
            .add(BlockusBlocks.MOSSY_CHARRED_PLANKS.slab);
        ...
        this.getOrCreateTagBuilder(new Identifier("c", "planks_that_burn"))
            ...
            .add(BlockusBlocks.RAW_BAMBOO.planks)
        ...
        this.getOrCreateTagBuilder(BlockTags.FENCE_GATES)
            .add(BlockusBlocks.RAW_BAMBOO.fence_gate)
        ...
        this.getOrCreateTagBuilder(BlockTags.STANDING_SIGNS)
            .add(BlockusBlocks.RAW_BAMBOO.standing_sign)
        ...
        this.getOrCreateTagBuilder(BlockTags.WALL_SIGNS)
            .add(BlockusBlocks.RAW_BAMBOO.wall_sign)
        ...
        this.getOrCreateTagBuilder(BlockTags.CEILING_HANGING_SIGNS)
            .add(BlockusBlocks.RAW_BAMBOO.ceiling_hanging_sign)
            .add(BlockusBlocks.CHARRED.ceiling_hanging_sign)
            .add(BlockusBlocks.WHITE_OAK.ceiling_hanging_sign);

        this.getOrCreateTagBuilder(BlockTags.WALL_HANGING_SIGNS)
            .add(BlockusBlocks.RAW_BAMBOO.wall_hanging_sign)
            .add(BlockusBlocks.CHARRED.wall_hanging_sign)
            .add(BlockusBlocks.WHITE_OAK.wall_hanging_sign);
        ...
        this.getOrCreateTagBuilder(BlockTags.WOODEN_PRESSURE_PLATES)
            .add(BlockusBlocks.RAW_BAMBOO.pressure_plate)

...
public class BlockusRecipesProvider extends FabricRecipeProvider {
    ...
    protected void generateRecipes(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(BlockusBlocks.CAUTION_BARRIER).input(BlockusBlocks.CAUTION_BLOCK).input(BlockusBlocks.ROAD_BARRIER_BLOCK).criterion(hasItem(BlockusBlocks.CAUTION_BLOCK), conditionsFromItem(BlockusBlocks.CAUTION_BLOCK)).criterion(hasItem(BlockusBlocks.ROAD_BARRIER_BLOCK), conditionsFromItem(BlockusBlocks.ROAD_BARRIER_BLOCK)).offerTo(exporter);

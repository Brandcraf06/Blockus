...
public class BlockusRecipeProvider extends FabricRecipeProvider {
    ...
    protected void generateRecipes(Consumer<RecipeJsonProvider> exporter) {
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(BlockusBlocks.ANDESITE_BRICKS.block), BlockusBlocks.CRACKED_ANDESITE_BRICKS.asItem(), 0.1F, 200).criterion(hasItem(BlockusBlocks.ANDESITE_BRICKS.block), conditionsFromItem(BlockusBlocks.ANDESITE_BRICKS.block)).offerTo(exporter);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(BlockusBlocks.DIORITE_BRICKS.block), BlockusBlocks.CRACKED_DIORITE_BRICKS.asItem(), 0.1F, 200).criterion(hasItem(BlockusBlocks.DIORITE_BRICKS.block), conditionsFromItem(BlockusBlocks.DIORITE_BRICKS.block)).offerTo(exporter);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(BlockusBlocks.GRANITE_BRICKS.block), BlockusBlocks.CRACKED_GRANITE_BRICKS.asItem(), 0.1F, 200).criterion(hasItem(BlockusBlocks.GRANITE_BRICKS.block), conditionsFromItem(BlockusBlocks.GRANITE_BRICKS.block)).offerTo(exporter);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(BlockusBlocks.DRIPSTONE_BRICKS.block), BlockusBlocks.CRACKED_DRIPSTONE_BRICKS.asItem(), 0.1F, 200).criterion(hasItem(BlockusBlocks.DRIPSTONE_BRICKS.block), conditionsFromItem(BlockusBlocks.DRIPSTONE_BRICKS.block)).offerTo(exporter);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(BlockusBlocks.TUFF_BRICKS.block), BlockusBlocks.CRACKED_TUFF_BRICKS.asItem(), 0.1F, 200).criterion(hasItem(BlockusBlocks.TUFF_BRICKS.block), conditionsFromItem(BlockusBlocks.TUFF_BRICKS.block)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(BlockusBlocks.VIRIDITE.block, 4).input('S', Blocks.DEEPSLATE).input('#', Blocks.SCULK).pattern(" S ").pattern("S#S").pattern(" S ").criterion(hasItem(Blocks.SCULK), conditionsFromItem(Blocks.SCULK)).criterion(hasItem(Blocks.DEEPSLATE), conditionsFromItem(Blocks.DEEPSLATE)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(BlockusBlocks.VIRIDITE.block, 4).input('S', Blocks.DEEPSLATE).input('#', Items.GREEN_DYE).pattern(" S ").pattern("S#S").pattern(" S ").criterion(hasItem(Items.GREEN_DYE), conditionsFromItem(Items.GREEN_DYE)).criterion(hasItem(Blocks.DEEPSLATE), conditionsFromItem(Blocks.DEEPSLATE)).offerTo(exporter, convertBetween(BlockusBlocks.VIRIDITE.block, Items.GREEN_DYE));
        ...
        offerStonecuttingRecipe(exporter, BlockusBlocks.SNOW_BRICKS.slab, BlockusBlocks.SNOW_BRICKS.block, 2);
        ...
        offerWallRecipe(exporter, BlockusBlocks.ICE_BRICK_WALL, BlockusBlocks.ICE_BRICKS);
        ...
        ShapedRecipeJsonBuilder.create(BlockusBlocks.NETHER_TILES.block, 4).input('#', Blocks.NETHERRACK).input('X', Blocks.NETHER_BRICKS).pattern("#X").pattern("X#").criterion(hasItem(Blocks.NETHER_BRICKS), conditionsFromItem(Blocks.NETHER_BRICKS)).offerTo(exporter);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(BlockusBlocks.OBSIDIAN_BRICKS.block), BlockusBlocks.CRACKED_OBSIDIAN_BRICKS.asItem(), 0.1F, 200).criterion(hasItem(BlockusBlocks.OBSIDIAN_BRICKS.block), conditionsFromItem(BlockusBlocks.OBSIDIAN_BRICKS.block)).offerTo(exporter);
        ...
        offerSlabRecipe(exporter, BlockusBlocks.CUT_SOUL_SANDSTONE_SLAB, BlockusBlocks.CUT_SOUL_SANDSTONE);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(BlockusBlocks.SOUL_SANDSTONE.block), BlockusBlocks.SMOOTH_SOUL_SANDSTONE.block.asItem(), 0.1F, 200).criterion("has_soul_sandstone", conditionsFromItem(BlockusBlocks.SOUL_SANDSTONE.block)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(BlockusBlocks.END_TILES.block, 4).input('#', Blocks.END_STONE).input('X', Blocks.PURPUR_BLOCK).pattern("#X").pattern("X#").criterion(hasItem(Blocks.PURPUR_BLOCK), conditionsFromItem(Blocks.PURPUR_BLOCK)).offerTo(exporter);
        ...
        offerPillarRecipe(exporter, BlockusBlocks.WHITE_GLAZED_TERRACOTTA_PILLAR, Blocks.WHITE_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.ORANGE_GLAZED_TERRACOTTA_PILLAR, Blocks.ORANGE_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.MAGENTA_GLAZED_TERRACOTTA_PILLAR, Blocks.MAGENTA_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.LIGHT_BLUE_GLAZED_TERRACOTTA_PILLAR, Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.YELLOW_GLAZED_TERRACOTTA_PILLAR, Blocks.YELLOW_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.LIME_GLAZED_TERRACOTTA_PILLAR, Blocks.LIME_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.PINK_GLAZED_TERRACOTTA_PILLAR, Blocks.PINK_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.LIGHT_GRAY_GLAZED_TERRACOTTA_PILLAR, Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.GRAY_GLAZED_TERRACOTTA_PILLAR, Blocks.GRAY_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.CYAN_GLAZED_TERRACOTTA_PILLAR, Blocks.CYAN_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.PURPLE_GLAZED_TERRACOTTA_PILLAR, Blocks.PURPLE_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.BLUE_GLAZED_TERRACOTTA_PILLAR, Blocks.BLUE_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.BROWN_GLAZED_TERRACOTTA_PILLAR, Blocks.BROWN_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.GREEN_GLAZED_TERRACOTTA_PILLAR, Blocks.GREEN_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.RED_GLAZED_TERRACOTTA_PILLAR, Blocks.RED_GLAZED_TERRACOTTA);
        offerPillarRecipe(exporter, BlockusBlocks.BLACK_GLAZED_TERRACOTTA_PILLAR, Blocks.BLACK_GLAZED_TERRACOTTA);
        ...
        ShapedRecipeJsonBuilder.create(BlockusBlocks.LEGACY_STONECUTTER).input('#', Blocks.COBBLESTONE).input('S', Blocks.STONECUTTER).pattern(" # ").pattern("#S#").pattern(" # ").criterion(hasItem(Blocks.STONECUTTER), conditionsFromItem(Blocks.STONECUTTER)).offerTo(exporter);
    ...
    public static void offerColoredTilesRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible color1, ItemConvertible color2) {
        ShapelessRecipeJsonBuilder.create(output, 2).input(color1).input(color2).group("colored_tiles").criterion(hasItem(color1), conditionsFromItem(color1)).criterion(hasItem(color2), conditionsFromItem(color2)).offerTo(exporter);
    ...
    public static void offerUnicolorColoredTilesRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible color) {
        ShapelessRecipeJsonBuilder.create(output, 2).input(color).input(color).group("colored_tiles").criterion(hasItem(color), conditionsFromItem(color)).offerTo(exporter);
    ...
    public static void offerSmallLogsRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible input) {
        ShapelessRecipeJsonBuilder.create(output, 3).input(input).input(input).input(input).group("small_logs").criterion(hasItem(input), conditionsFromItem(input)).offerTo(exporter);
    ...
    public static void offerSmallHedgesRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible input) {
        ShapedRecipeJsonBuilder.create(output, 6).input('#', input).pattern("###").pattern("###").group("small_hedge").criterion(hasItem(input), conditionsFromItem(input)).offerTo(exporter);
    }
    ...
    public static void offerStoneDoorTrapdoorRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible door, ItemConvertible trapdoor, ItemConvertible input, ItemConvertible slab) {
        ...
        ShapedRecipeJsonBuilder.create(trapdoor, 4).input('#', slab).pattern("###").pattern("###").criterion(hasItem(slab), conditionsFromItem(slab)).offerTo(exporter);
    }
    ...
    public static void offerStonecuttingRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, int count, ItemConvertible... ingredients) {
        ...
        for (ItemConvertible itemConvertible : ingredients) {
            SingleItemRecipeJsonBuilder var10000 = SingleItemRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(itemConvertible), output, count).criterion(hasItem(itemConvertible), conditionsFromItem(itemConvertible));

...
public class BlockusBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void generateTags() {
        ...
        this.getOrCreateTagBuilder(BlockTags.WALLS)
            ...
            .add(BlockusBlocks.WHITE_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.ORANGE_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.MAGENTA_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.LIGHT_BLUE_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.YELLOW_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.LIME_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.PINK_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.GRAY_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.LIGHT_GRAY_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.CYAN_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.PURPLE_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.BLUE_CONCRETE_BRICK_WALL)
            .add(BlockusBlocks.BROWN_CONCRETE_BRICK_WALL)
